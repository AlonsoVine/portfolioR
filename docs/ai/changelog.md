...
- Timeline: Cards ahora tienen el hover/glow de Education (elevaci�n, gradiente sutil y sombra reforzada).
- Fixes: Keys �nicas en SkillsGrid y data-theme=dark en html para minimizar errores de hidrataci�n.
- Timeline: Se muestran logos de empresa (Inetum, FCC, Atos) junto al nombre en cada card; assets SVG a�adidos en public/images/company.
...
- DevOps: A�adido workflow de Deploy (prefijo 'deploy:' en commit) que construye y despliega a GitHub Pages usando upload-pages-artifact/deploy-pages.
